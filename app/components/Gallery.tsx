  ...
  return (
    <div className="max-w-[1200px] mx-auto my-12 px-4">
      <div className="flex flex-col md:flex-row md:items-start md:justify-center">
        {/* Image principale */}
        <div className="w-full h-[300px] md:h-[600px] md:w-3/4 overflow-hidden">
          <img
            src={selectedImage}
            alt="Selected"
        ...
        {/* Miniatures */}
        <div className="flex md:flex-col space-x-4 md:space-x-0 md:space-y-4 mt-4 md:mt-0 md:ml-4 overflow-x-auto">
